...
For debugging purposes, you can enable HTML dumping to save scraped pages to disk:

- `SCRAPER_LOG_HTML`: Enable HTML dumping (default: false)
- `SCRAPER_HTML_LOG_DIR`: Directory for HTML dump files (default: logs/html)

When enabled, HTML files are saved with the pattern: `ASIN_YYYY-MM-DDThh-mm-ssZ_suffix.html`

Example usage:
```bash
SCRAPER_LOG_HTML=true SCRAPER_HTML_LOG_DIR=debug/html ./bin/amazon-scraper -asins "B08N5WRWNW"
```

This will save:
- `B08N5WRWNW_2025-08-10T12-34-56Z_page.html` - The main product page
- `B08N5WRWNW_2025-08-10T12-34-57Z_size_table.html` - The size table modal (if available)
